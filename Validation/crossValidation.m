...
function [confusionMatrix, avgRec, avgPrec, avgMeas] = crossValidation(k, examples, outputLabels)
    ...
    while iterationNumber <= k
        ...
        testLabels       = outputLabels(currenrestIndex : testingSetSize, :);
        ...
        error_rate = classificationError(predictions, testLabels);
        disp('iteration ' + k);
        disp(error_rate);
